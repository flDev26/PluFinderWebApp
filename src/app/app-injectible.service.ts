...
export class AppInjectibleService {
  ...
  //GET:Get "Market" entries with a matching first "category" entry.
  GetMarketFirstCategoryFromDb(query:string):Observable<Product[]>{
    return this.http.get<Product[]>(`${this.hostURL}/filteredSearchByMarketFirstCategory`,{params:{query:query}});
  }
