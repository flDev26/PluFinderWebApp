...
export class ProduceComponent implements OnInit,OnDestroy{
  ...
  //Accordion content.
  cordionItems=[
    {title:'Cashier Tips',content:'Reminders geared towards cashiers. Under Development.',isOpen:false},
  ...
  ngOnInit():void{
    ...
    console.log('PRD-Reset1B:',this.appCom.products$);
    this.appCom.resetProducts();
    console.log('PRD-Reset1A:',this.appCom.products$);
    ...
    this.subscriptions.add(
      this.appCom.products$.subscribe((data:Product[])=>{
        ...
        if(this.products.length===0){
          console.log('PRD-Products array is empty.');
        }else{console.log('PRD-Products loaded(obs):',this.appCom.products$);}
  ...
  ngOnDestroy():void{
     ...
     console.log('PRD-Reset2B:',this.appCom.products$);
     this.appCom.resetProducts();
     console.log('PRD-Reset2A:',this.appCom.products$);
  }
